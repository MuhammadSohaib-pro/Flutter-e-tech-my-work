...
class ServicesAddEditItemView extends StatefulWidget {
  const ServicesAddEditItemView({super.key, required this.process});
  final String process;

  @override
  State<ServicesAddEditItemView> createState() =>
      _ServicesAddEditItemViewState();
}

class _ServicesAddEditItemViewState extends State<ServicesAddEditItemView> {
  @override
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: DropdownMenu<String>(
                    ...
                    hintText:
                        AppLocalizations.of(context)!.selectCategory.toString(),
                    textStyle: TextStyle(
                      color: ThemeColors.black1,
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: DropdownMenu<String>(
                    width: MySize.screenWidth / 1.3,
                    hintText:
                        AppLocalizations.of(context)!.selectBranch.toString(),
                    textStyle: TextStyle(
                      color: ThemeColors.black1,
                      fontSize: MySize.size14,
                      fontWeight: FontWeight.w400,
