...
import 'package:event_manager_app/screens/kitchen_details/kitchen_add_edit_item_view.dart';
...
class KitchenDetailsView extends StatefulWidget {
  const KitchenDetailsView({super.key});
          ...
          Bubble(
            ...
            onPress: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const KitchenAddEditItemView(process: "Add"),
                ),
              );
            },
          ),
