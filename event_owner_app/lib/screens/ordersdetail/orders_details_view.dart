...
class OrdersDetailsView extends StatefulWidget {
  OrdersDetailsView({super.key, required this.orderStatus});
  String orderStatus;
  @override
  State<OrdersDetailsView> createState() => _OrdersDetailsViewState();
}

class _OrdersDetailsViewState extends State<OrdersDetailsView> {
  @override
            ...
            SingleChildScrollView(
              child: Column(
                ...
                children: [
                        ...
                        Text.rich(
                          TextSpan(
                            children: [
                              TextSpan(
                                text:
                                    '${AppLocalizations.of(context)!.deliveryCharges.toString()} ',
                                style: TextStyle(
                                  color: ThemeColors.grey1,
                  ...
                  Padding(
                    padding: Spacing.horizontal(MySize.size32),
                    child: widget.orderStatus == "New" ||
                            widget.orderStatus == "Ongoing"
                        ? CustomButton8(
                            text: widget.orderStatus == "New"
                                ? AppLocalizations.of(context)!.acceptOrder.toString()
                                : widget.orderStatus == "Ongoing"
                                    ? AppLocalizations.of(context)!.readyForPick.toString()
                                    : '',
                            onPressed: widget.orderStatus == "New"
                                ? () {
                                    //new Accept Order
                                  }
                                : widget.orderStatus == "Ongoing"
                    ...
                    widget.orderStatus == "New" ||
                        ...
                        ? TextButton(
                            onPressed: widget.orderStatus == "New" ||
                                ...
                                : () {},
                            child: Text(
                              AppLocalizations.of(context)!.cancelOrder.toString(),
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                color: ThemeColors.mainColor,
                                fontSize: MySize.size12,
...
class FourOrderStepTile extends StatelessWidget {
  ...
  final OrdersDetailsView widget;
