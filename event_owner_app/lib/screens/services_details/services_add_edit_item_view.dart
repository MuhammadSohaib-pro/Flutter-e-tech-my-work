...
class ServiceAddEditItemView extends StatefulWidget {
  ...
  @override
  State<ServiceAddEditItemView> createState() => _ServiceAddEditItemViewState();
}

class _ServiceAddEditItemViewState extends State<ServiceAddEditItemView> {
  ...
  setInitialsData() async {
    ...
    final p = Provider.of<AddEditServicesProvider>(context, listen: false);
    var firestore = await FirebaseFirestore.instance
        .collection("restaurants")
        .doc(ref)
  ...
  selectImageBottomSheet(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        return Consumer<AddEditServicesProvider>(
          builder: (context, p, child) => Padding(
  ...
  Future<String?> uploadImageToFirebase(String? imagePath) async {
    final obj = Provider.of<AddEditServicesProvider>(context, listen: false);
    try {
