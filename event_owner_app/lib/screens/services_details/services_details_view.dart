...
import 'package:event_owner_app/screens/services_details/provider/add_edit_service_provider.dart';
import 'package:event_owner_app/screens/services_details/services_add_edit_item_view.dart';
...
class _ServiceDetailsViewState extends State<ServiceDetailsView>
  ...
  void initState() {
    ...
    //   context.read<AddEditServicesProvider>().fetchSomething();
    // });
    Future.delayed(Duration.zero).then((_) {
      context.read<AddEditServicesProvider>().fetchSomething().then((value) {});
    });
    Future.delayed(Duration.zero).then((_) {
      context.read<AddEditServicesProvider>().getKitchens().then((value) {});
    });
    super.initState();
  }
      ...
      children: [
        Scaffold(
          appBar: AppBar(
            ...
            actions: [
              Consumer<AddEditServicesProvider>(
                            ...
                            builder: (context, snapshot2) {
                              if (snapshot2.hasData) {
                                ...
                                if (snapshot2.data != null) {
                                  ...
                                  if (data2.isNotEmpty) {
                                    final pr =
                                        Provider.of<AddEditServicesProvider>(
                                            context,
                                            listen: false);
                                    pr.setCategory(
          ...
          floatingActionButton: Consumer<AddEditServicesProvider>(
          ...
          child: InkWell(
            child: Padding(
              ...
              child: Container(
                ...
                child: Consumer<AddEditServicesProvider>(
                    ...
                    InkWell(
                      onTap: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => ServiceAddEditItemView(
