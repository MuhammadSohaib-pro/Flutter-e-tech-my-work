...
class BranchWalletView extends StatefulWidget {
  const BranchWalletView({super.key});

  @override
  State<BranchWalletView> createState() => _BranchWalletViewState();
}

String selectedBtn = "earningHistory";

class _BranchWalletViewState extends State<BranchWalletView> {
  @override
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    padding:
                        Spacing.fromLTRB(0, MySize.size20, 0, MySize.size20),
                    child: Align(
                      alignment: Alignment.center,
                      child: Text(
                        type == "add"
                  ...
                  children: [
                    ...
                    Text.rich(
                      TextSpan(
                        children: [
                          TextSpan(
                            text: AppLocalizations.of(context)!.accountNumber.toString(),
                            style: TextStyle(
                              color: titleColor,
                              fontSize: MySize.size10,
                              fontWeight: FontWeight.w400,
