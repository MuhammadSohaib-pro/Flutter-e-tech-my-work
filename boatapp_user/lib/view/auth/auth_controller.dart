...
import 'Signup_phone_and_google.dart';
  ...
  Future<UserCredential?> signInWithEmail(BuildContext context,String email, String password) async {
    ...
    try {
      ...
      if (e is FirebaseAuthException) {
        ...
        switch (e.code) {
          case 'invalid-email':
            errorMessage = AppLocale.invalidEmail.getString(context);
            break;
          case 'user-not-found':
            errorMessage = AppLocale.userNotFound.getString(context);
            break;
          case 'wrong-password':
            errorMessage = AppLocale.invalidPassword.getString(context);
            break;
        // Add more cases as per your requirements
          default:
            errorMessage = AppLocale.anErrorOccurred.getString(context);
        }
