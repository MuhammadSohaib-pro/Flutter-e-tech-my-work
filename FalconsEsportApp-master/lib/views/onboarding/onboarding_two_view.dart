...
import 'package:falconsesportsapp/views/onboarding/onboarding_three_view.dart';
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                Navigator.push(
                  context,
                  CommonFunctions.createRoute(const OnBoardingView3()),
                );
              },
