...
import 'package:event_manager_app/screens/kitchen_details/kitchen_details_view.dart';
import 'package:event_manager_app/screens/notifications/notification_view.dart';
import 'package:event_manager_app/screens/settings/settings_view.dart';
                ...
                Row(
                  ...
                  children: [
                    InkWell(
                      ...
                      child: SvgPicture.asset(icSettingOutlined,
        ...
        InkWell(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const KitchenDetailsView(),
              ),
            );
          },
