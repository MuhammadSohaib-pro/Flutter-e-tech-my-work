...
class ServiceRestaurantView extends StatefulWidget {
  const ServiceRestaurantView({super.key});

  @override
  State<ServiceRestaurantView> createState() => _ServiceRestaurantViewState();
}

class _ServiceRestaurantViewState extends State<ServiceRestaurantView>
        ...
        title: IconButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const ServiceSearchView(),
              ),
            );
          },
          icon: const Icon(
      ...
      body: SafeArea(
        child: Column(
          children: [
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                    image: AssetImage(imgServicesoverlay), fit: BoxFit.fill),
              ),
              child: Container(
                height: MySize.size250,
                width: double.infinity,
            ...
            //         children: [
            //           Text(
            //             AppLocalizations.of(context)!.chairs.toString(),
            //             textAlign: TextAlign.center,
            //             style: TextStyle(
            //               color: ThemeColors.black1,
            ...
            //         children: [
            //           Text(
            //             AppLocalizations.of(context)!.tables.toString(),
            //             textAlign: TextAlign.center,
            //             style: TextStyle(
            //               color: ThemeColors.black1,
            //               fontSize: MySize.size14,
            ...
            //         children: [
            //           Text(
            //             AppLocalizations.of(context)!.servants.toString(),
            //             textAlign: TextAlign.center,
            //             style: TextStyle(
            //               color: ThemeColors.black1,
            //               fontSize: MySize.size14,
